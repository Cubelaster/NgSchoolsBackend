...
namespace NgSchoolsBusinessLayer.Services.Implementations
{
    public class PlanService : IPlanService
    {
        ...
        public async Task<ActionResponse<PlanDto>> GetByEducationProgramId(int educationPrograMid)
        {
            ...
            {
                var entity = unitOfWork.GetGenericRepository<Plan>()
                    .FindBy(c => c.EducationPogramId == educationPrograMid, includeProperties: "PlanDays.Subjects.Themes");
                return await ActionResponse<PlanDto>
                    .ReturnSuccess(mapper.Map<Plan, PlanDto>(entity));
            }
            catch (Exception ex)
        ...
        public Task<ActionResponse<PlanDto>> Update(PlanDto entityDto)
        {
            throw new NotImplementedException();
        }

        public Task<ActionResponse<PlanDto>> Delete(int id)
        {
            throw new NotImplementedException();
        }
