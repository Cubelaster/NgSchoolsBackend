...
namespace NgSchoolsBusinessLayer.Services.Implementations
{
    public class StudentGroupService : IStudentGroupService
    {
        ...
        private readonly string includeCombinedProperties =
            "StudentGroups.ClassLocation.Country,StudentGroups.ClassLocation.Region,StudentGroups.ClassLocation.Municipality,StudentGroups.ClassLocation.City," +
            "StudentGroups.StudentsInGroups.Student, StudentGroups.StudentsInGroups.Employer,StudentGroups.SubjectTeachers,StudentGroups.EducationLeader.UserDetails.Signature," +
