...
namespace NgSchoolsBusinessLayer.Services.Implementations
{
    public class StudentGroupService : IStudentGroupService
    {
        ...
        private readonly string includeProperties = "ClassLocation,StudentsInGroups.Student,StudentsInGroups.Student.StudentsInGroups.StudentRegisterEntry,StudentsInGroups.Employer,SubjectTeachers,EducationLeader.UserDetails.Signature,Director.UserDetails.Signature,ExamCommission.UserExamCommissions.User.UserDetails,StudentGroupClassAttendances.StudentClassAttendances";
        private readonly string includeCombinedProperties = "StudentGroups.ClassLocation,StudentGroups.StudentsInGroups.Student,StudentGroups.StudentsInGroups.Employer,StudentGroups.SubjectTeachers,StudentGroups.EducationLeader.UserDetails.Signature,StudentGroups.Director.UserDetails.Signature,StudentGroups.ExamCommission.UserExamCommissions.User.UserDetails,StudentGroups.StudentGroupClassAttendances.StudentClassAttendances,StudentGroups.Program.EducationGroup";
